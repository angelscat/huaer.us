...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[["undo","redo",'|',"selectall","cleardoc",'|',"superscript","subscript","horizontal",'|',"unlink","link","preview","fullscreen"],
                    ["bold","italic","underline","strikethrough",'|',"fontfamily","fontsize",'|',"forecolor","backcolor",'|',"insertunorderedlist","insertorderedlist","indent",'|',"justifyleft","justifycenter","justifyright","justifyjustify",'|',"removeformat","autotypeset"]]
    ...
    //,lang:'zh-cn'
        ...
        ,initialContent:'欢迎投稿!'    //初始化编辑器的内容,也可以通过textarea/script给值，看官网例子

        ,initialFrameWidth:684  //初始化编辑器宽度,默认1000
