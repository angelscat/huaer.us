...
class DataListCP
{
    ...
    function GetPageList($atts,$refObj='',$fields=array())
    {
        ...
        if($this->pageNO != 1)
        {
            $prepage .= "<li><a class='prePage' href='".$purl."pageno=$prepagenum'>$lang_pre_page</a></li> \n";
            $indexpage = "<li><a class='indexPage' href='".$purl."pageno=1'>$lang_index_page</a></li> \n";
        }
        else
        {
            $indexpage = "";
        ...
        {
            $nextpage.="<li><a class='nextPage' href='".$purl."pageno=$nextpagenum'>$lang_next_page</a></li> \n";
            $endpage="<li><a class='endPage' href='".$purl."pageno=$totalpage'>$lang_end_page</a></li> \n";
        }
        else
        {
            $endpage="";
